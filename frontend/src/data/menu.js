...
const menuLanguage = {
  ...
  es: {
    categories: ["Antipasti y fritos", "Pinsa", "Pasta y al horno", "Carnes y pescados", "Especialidades dominicanas", "Postres", "Vinos", "Almuerzo", "Ofertas para grupos"],
    nav: ["Antipasti", "Pinsa", "Pasta", "Carnes y pescados", "Dominicano", "Postres", "Vinos", "Almuerzo", "Grupos"],
    rails: ["Selección ITACAN", "Pinsa", "Pasta y cocina", "Alma caribeña", "Postres"],
    notes: ["Todos los precios están en CHF e incluyen IVA.", "Para obtener información sobre los alérgenos de cada plato, consulta a nuestro equipo."],
    lunchNote: "Miércoles, jueves y viernes · 11:30–14:00 · CHF 20.– incluye ensalada y espresso",
    wineSubgroups: ["Por copa", "Botellas"],
    dietary: { vegetarisch: "vegetariano", vegan: "vegano" },
    offers: [{ priceSuffix: "por persona", description: "Un menú para compartir en toda la mesa con antipasti, pinsa, pasta, especialidades dominicanas y postre.", note: "Reserva obligatoria.", cta: "Consultar Tavolata" }, { priceSuffix: "por persona", description: "Una pinsa tras otra, con distintos sabores y una mesa que decide cuándo ha tenido suficiente. Ideal para grupos y amigos.", note: "A partir de 4 personas.", cta: "Reservar Giro Pinsa" }],
    replacements: [["Für 2 Personen", "Para 2 personas"], ["Zum Teilen", "Para compartir"], ["Haus-Spezialität", "Especialidad de la casa"], ["Hausgemachtes Tagesdessert", "Postre casero del día"], ["Hausgemachtes Tiramisu", "Tiramisú casero"], ["serviert mit", "servido con"], ["leicht scharf", "ligeramente picante"], ["Frittierte", "Frito"], ["Gebratene", "Salteado"], ["Gegrilltes", "A la parrilla"], ["Gebackene", "Al horno"], ["Gemischte", "Surtido de"], ["Gemischter", "Ensalada mixta"], ["hausgemachter", "casero"], ["gefüllt mit", "relleno de"], ["überbacken", "gratinado"], ["Tomatensauce", "salsa de tomate"], ["Büffelmozzarella", "mozzarella de búfala"], ["Cherry-Tomaten", "tomates cherry"], ["Champignons", "champiñones"], ["Rohschinken", "jamón curado"], ["Vorderschinken", "jamón"], ["scharfe Salami", "salami picante"], ["Auberginen", "berenjenas"], ["Zucchini", "calabacines"], ["Zucchetti", "calabacines"], ["Crevetten", "gambas"], ["Meeresfrüchten", "mariscos"], ["Calamari", "calamares"], ["Oktopus", "pulpo"], ["Knoblauch", "ajo"], ["Zitrone", "limón"], ["Bratkartoffeln", "patatas asadas"], ["Kartoffeln", "patatas"], ["Kochbanane", "plátano macho"], ["kleinem Salat", "una ensalada pequeña"], ["kleiner Salat", "una ensalada pequeña"], ["Gemüse", "verduras"], ["Rindshackfleisch", "carne de res picada"], ["Rindfleisch", "carne de res"], ["Poulet", "pollo"], ["Schweine", "cerdo"], ["Lachs", "salmón"], ["Rahmsauce", "salsa de crema"], ["Trüffelcrème-Sauce", "salsa cremosa de trufa"], ["Vanille", "vainilla"], ["Erdbeere", "fresa"], ["Schokolade", "chocolate"], ["Kaffee", "café"], [" und ", " y "], [" mit ", " con "]],
  },
};
...
const exactMenuText = {
  ...
  es: [["Knuspriges Brot mit Tomaten, Basilikum und Oregano", "Pan crujiente con tomates, albahaca y orégano"], ["Frittierte Pouletstücke", "Trozos de pollo frito"], ["Gemischter Salat", "Ensalada mixta"]],
};
